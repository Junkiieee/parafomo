...
> Üretim: 2026-09-05 · `scripts/dashboard.py` · soru: *sistem işe yarıyor mu?*
...
- Organic Video: 54 kullanıcı
- Organic Search: 39 kullanıcı
- Organic Social: 23 kullanıcı
- Referral: 3 kullanıcı
...
- `abd de faiz artarsa altın ne olur` — sıra 5.8, gös 16, tık 0
...
- `jackson hole sempozyumu nedir` — sıra 8.8, gös 79, tık 0
- `bedelsizhisse` — sıra 9.0, gös 3, tık 0

**🎯 Ulaşılabilir fırsatlar (sıra 4-20, gösterim≥5):**
- `jackson hole toplantısı ne zaman` — sıra 9.1, gös 130
- `jackson hole sempozyumu nedir` — sıra 8.8, gös 79
- `jackson hole toplantısı nedir` — sıra 9.1, gös 76
- `jackson hole nedir` — sıra 10.4, gös 64
...
- **Abone:** 42  ·  **Toplam izlenme:** 45,456  ·  **Video:** 230
