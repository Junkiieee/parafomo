...
> Üretim: 2026-08-26 · `scripts/dashboard.py` · soru: *sistem işe yarıyor mu?*
...
- Organic Video: 38 kullanıcı
- Organic Search: 21 kullanıcı
...
- **Abone:** 35  ·  **Toplam izlenme:** 41,342  ·  **Video:** 198
- İzlenme/abone dönüşümü: **0.08%** (izleyen kaç kişi abone/huniye giriyor)

## 4) 🎯 DÜRÜST HÜKÜM

**Hedef:** 1000 ziyaretçi/gün = 7,000/hafta gerçek erişim.
**Gerçek durum:** son hafta **12** gerçek ziyaretçi = hedefin **%0.17**'si. Kalan: **6,988** kişi/hafta.
