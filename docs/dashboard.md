...
> Üretim: 2026-09-15 · `scripts/dashboard.py` · soru: *sistem işe yarıyor mu?*
...
**Son hafta Direct payı:** %36 (yüksekse trafik gerçek ziyaretçi değil, senin/botların erişimi)

**Gerçek erişim kaynağı (son 4 hafta toplamı):**
- Organic Search: 49 kullanıcı
- Organic Video: 31 kullanıcı
- Organic Social: 23 kullanıcı
- AI Assistant: 10 kullanıcı
...
- `"albayrak hazır beton"` — sıra 6.3, gös 31, tık 0
...
- `fed faiz kararı takvimi` — sıra 11.1, gös 56
- `buyback nedir` — sıra 11.0, gös 45
- `abd de faiz artarsa altın ne olur` — sıra 7.6, gös 42
- `fed toplantı tarihleri 2026` — sıra 10.0, gös 37
- `"albayrak hazır beton"` — sıra 6.3, gös 31

## 3) YouTube motoru

- **Abone:** 46  ·  **Toplam izlenme:** 52,386  ·  **Video:** 250
- İzlenme/abone dönüşümü: **0.09%** (izleyen kaç kişi abone/huniye giriyor)

## 4) 🎯 DÜRÜST HÜKÜM

**Hedef:** 1000 ziyaretçi/gün = 7,000/hafta gerçek erişim.
**Gerçek durum:** son hafta **7** gerçek ziyaretçi = hedefin **%0.10**'si. Kalan: **6,993** kişi/hafta.
