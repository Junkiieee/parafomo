...
> Üretim: 2026-09-08 · `scripts/dashboard.py` · soru: *sistem işe yarıyor mu?*
...
**Son hafta Direct payı:** %11 (yüksekse trafik gerçek ziyaretçi değil, senin/botların erişimi)

**Gerçek erişim kaynağı (son 4 hafta toplamı):**
- Organic Video: 45 kullanıcı
- Organic Search: 38 kullanıcı
- Organic Social: 20 kullanıcı
- AI Assistant: 4 kullanıcı
...
- `abd de faiz artarsa altın ne olur` — sıra 7.2, gös 32

## 3) YouTube motoru

- **Abone:** 43  ·  **Toplam izlenme:** 45,560  ·  **Video:** 239
