...
> Üretim: 2026-09-11 · `scripts/dashboard.py` · soru: *sistem işe yarıyor mu?*
...
**Son hafta Direct payı:** %25 (yüksekse trafik gerçek ziyaretçi değil, senin/botların erişimi)

**Gerçek erişim kaynağı (son 4 hafta toplamı):**
- Organic Search: 46 kullanıcı
- Organic Video: 45 kullanıcı
- Organic Social: 25 kullanıcı
- Cross-network: 7 kullanıcı
- AI Assistant: 5 kullanıcı
...
- `"albayrak hazır beton"` — sıra 4.9, gös 15, tık 0
- `fed faiz kararı ne zaman eylül 2026 fomc toplantısı` — sıra 7.0, gös 3, tık 0
- `abd de faiz artarsa altın ne olur` — sıra 7.2, gös 33, tık 0
- `fed faiz kararı bugün 12 ağustos 2026 fomc faiz kararı` — sıra 7.3, gös 3, tık 0
- `abd faiz yükseltirse altın ne olur` — sıra 7.5, gös 4, tık 0
- `borsa neden düşer` — sıra 7.8, gös 6, tık 0
...
- `jackson hole ne zaman` — sıra 9.4, gös 67
- `fed faiz kararı takvimi 2026` — sıra 10.7, gös 53
- `fed faiz kararı takvimi` — sıra 10.9, gös 50
- `abd de faiz artarsa altın ne olur` — sıra 7.2, gös 33
- `fed toplantı tarihleri 2026` — sıra 10.6, gös 30
- `boj nedir` — sıra 8.8, gös 26
- `fed kararı` — sıra 19.3, gös 19

## 3) YouTube motoru

- **Abone:** 43  ·  **Toplam izlenme:** 49,070  ·  **Video:** 243
- İzlenme/abone dönüşümü: **0.09%** (izleyen kaç kişi abone/huniye giriyor)

## 4) 🎯 DÜRÜST HÜKÜM

**Hedef:** 1000 ziyaretçi/gün = 7,000/hafta gerçek erişim.
**Gerçek durum:** son hafta **30** gerçek ziyaretçi = hedefin **%0.43**'si. Kalan: **6,970** kişi/hafta.
