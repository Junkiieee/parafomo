...
> Üretim: 2026-08-10 · `scripts/dashboard.py` · soru: *sistem işe yarıyor mu?*
...
**Son hafta Direct payı:** %64 (yüksekse trafik gerçek ziyaretçi değil, senin/botların erişimi)

**Gerçek erişim kaynağı (son 4 hafta toplamı):**
- Organic Search: 7 kullanıcı
- Organic Social: 3 kullanıcı
- Organic Video: 2 kullanıcı
...
- `genç yaşta nasıl yatırım yapılır` — sıra 16.5, gös 4, tık 0
- `endex fonu nedir` — sıra 18.3, gös 3, tık 0
- `abd faiz kararı` — sıra 18.4, gös 9, tık 0
...
- `fed faiz kararı ne olur yorumlar` — sıra 19.0, gös 6
- `gdp ne demek` — sıra 14.2, gös 6
- `fed faiz kararı nedir` — sıra 12.8, gös 5
- `fed in faiz kararı` — sıra 19.6, gös 5
- `nfp verisi` — sıra 5.4, gös 5

## 3) YouTube motoru

- **Abone:** 20  ·  **Toplam izlenme:** 25,288  ·  **Video:** 133
- İzlenme/abone dönüşümü: **0.08%** (izleyen kaç kişi abone/huniye giriyor)

## 4) 🎯 DÜRÜST HÜKÜM

**Hedef:** 1000 ziyaretçi/gün = 7,000/hafta gerçek erişim.
**Gerçek durum:** son hafta **8** gerçek ziyaretçi = hedefin **%0.11**'si. Kalan: **6,992** kişi/hafta.

**Teşhis:**
- ⚠️ Trafiğin %64'i Direct — bu büyük ihtimalle sen + botlar, gerçek keşif değil. Çıplak sayıya güvenme.
