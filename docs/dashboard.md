...
> Üretim: 2026-09-01 · `scripts/dashboard.py` · soru: *sistem işe yarıyor mu?*
...
| 2026-08-24 | 10 | 2500 | %0.4 |

**Tıklama trendi:** `▁▁▁▁▃▃▅█`  📈 artıyor

**En iyi sıralanan sorgular (gösterim≥3):**
- `abd de faiz artarsa altın ne olur` — sıra 5.8, gös 15, tık 0
...
- `jackson hole sempozyumu nedir` — sıra 8.9, gös 78, tık 0
...
- `jackson hole sempozyumu nedir` — sıra 8.9, gös 78
...
- **Abone:** 41  ·  **Toplam izlenme:** 44,689  ·  **Video:** 221
