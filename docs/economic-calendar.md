...
> Son güncelleme: 2026-08-31 · `scripts/fetch-economic-calendar.py` tarafından üretilir. ELLE DÜZENLEME.
...
|-------|-----|------|-------|------|------|----------------|
| 2026-09-01 | Salı | 2:00pm | 🇺🇸 | 🔴 High | ISM Manufacturing PMI | ISM/PMI — ABD ekonomik aktivitesi, risk iştahı. |
...
| 2026-09-04 | Cuma | 8:50am | 🇬🇧 | 🔴 High | BOE Gov Bailey Speaks |  |
