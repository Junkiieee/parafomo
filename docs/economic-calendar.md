...
> Son güncelleme: 2026-07-08 · `scripts/fetch-economic-calendar.py` tarafından üretilir. ELLE DÜZENLEME.
...
|-------|-----|------|-------|------|------|----------------|
| 2026-07-08 | Çarşamba | 21:00 | 🇺🇸 | 🔴 High | FOMC Meeting Minutes | Fed/FOMC — küresel faiz beklentisi TL'yi etkiler. |
