...
> Üretim: 2026-08-17 · Dönem: son 28 gün · Kaynak: `scripts/seo-opportunities.py`
...
- [ ] `boj nedir` — gösterim 7, sıra 11.9, tıklama 0
- [ ] `abd merkez bankası faiz kararı` — gösterim 7, sıra 26.9, tıklama 0
- [ ] `2026 fed toplantı tarihleri` — gösterim 4, sıra 10.2, tıklama 0
- [ ] `amerika faiz kararı` — gösterim 4, sıra 25.5, tıklama 0
- [ ] `amerikan dolar endeksi` — gösterim 4, sıra 30.0, tıklama 0
