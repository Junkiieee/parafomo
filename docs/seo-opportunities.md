...
> Üretim: 2026-08-27 · Dönem: son 28 gün · Kaynak: `scripts/seo-opportunities.py`
...
- [x] `jackson hole ne zaman` — gösterim 54, sıra 9.3, tıklama 1 → `jackson-hole-2026-ne-zaman-warsh-konusmasi` (27 Ağustos 2026)
- [ ] `boj nedir` — gösterim 17, sıra 8.8, tıklama 0
- [ ] `abd faiz kararı` — gösterim 12, sıra 19.4, tıklama 0
- [ ] `amerikan dolar endeksi` — gösterim 10, sıra 32.4, tıklama 0
- [ ] `abd fed kararı` — gösterim 9, sıra 26.9, tıklama 0
- [ ] `2026 fed toplantı tarihleri` — gösterim 7, sıra 9.3, tıklama 0
- [ ] `abd merkez bankası faiz kararı` — gösterim 7, sıra 26.9, tıklama 0
- [ ] `amerika faiz kararı` — gösterim 5, sıra 25.8, tıklama 0
- [ ] `boj ne demek` — gösterim 3, sıra 8.0, tıklama 0
- [ ] `abd faiz artırımı doları nasıl etkiler` — gösterim 3, sıra 17.3, tıklama 0
