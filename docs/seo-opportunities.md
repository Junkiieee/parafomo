...
> Üretim: 2026-08-25 · Dönem: son 28 gün · Kaynak: `scripts/seo-opportunities.py`
...
- [ ] `boj nedir` — gösterim 14, sıra 8.6, tıklama 0
- [ ] `abd faiz kararı` — gösterim 13, sıra 19.6, tıklama 0
- [ ] `amerikan dolar endeksi` — gösterim 10, sıra 32.4, tıklama 0
- [ ] `abd fed kararı` — gösterim 8, sıra 27.1, tıklama 0
- [ ] `2026 fed toplantı tarihleri` — gösterim 7, sıra 9.3, tıklama 0
- [ ] `abd merkez bankası faiz kararı` — gösterim 7, sıra 26.9, tıklama 0
- [ ] `amerika faiz kararı` — gösterim 6, sıra 26.2, tıklama 0
