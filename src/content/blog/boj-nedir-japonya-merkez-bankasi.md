---
title: "BOJ Nedir? Japonya Merkez Bankası Araçları ve Küresel Piyasalara Etkisi"
description: "BOJ (Bank of Japan) nedir, nasıl çalışır? Sıfır faiz, YCC, QQE ve 2024 normalleşmesini Türk yatırımcısı için sade dille anlattık."
pubDate: 2026-08-14
category: "Ekonomi"
tags: ["boj nedir", "japonya merkez bankası", "ycc nedir", "merkez bankası araçları", "japonya ekonomisi", "küresel faiz politikası"]
readingTime: 8
featured: false
faq:
  - q: "BOJ ne demek, açılımı nedir?"
    a: "BOJ, 'Bank of Japan'ın kısaltmasıdır; Türkçede Japonya Merkez Bankası olarak bilinir. 1882'de kurulan banka, Japonya'nın para politikasını yönetir, faiz oranlarını belirler ve finansal sistemi denetler."
  - q: "YCC (Getiri Eğrisi Kontrolü) nedir?"
    a: "YCC (Yield Curve Control), BOJ'un belirli vadeli devlet tahvilleri için hedef faiz aralığı belirleyip bu aralığı korumak adına piyasada alım-satım yapması sistemidir. BOJ bu araçla 10 yıllık Japon tahvil faizini uzun yıllar boyunca sıfır bandında sabit tuttu."
  - q: "BOJ niçin onlarca yıl sıfır faiz uyguladı?"
    a: "Japonya 1990'larda büyük bir varlık balonunun patlamasının ardından deflasyon sarmalına girdi. Fiyatların sürekli düşmesi ekonomiyi felç etti. BOJ deflasyonla mücadele ve büyümeyi canlandırmak için faizleri onlarca yıl sıfır ya da negatif düzeyde tuttu."
  - q: "BOJ 2024'te neden faiz artırdı?"
...
| Özellik | BOJ | Fed | ECB | TCMB |
|---------|-----|-----|-----|------|
| Tarihsel faiz yönü | Onlarca yıl sıfır/negatif | Çevrimsel (artırıp düşürür) | Negatiften normalleşme | Yüksek, enflasyona bağlı |
| Getiri eğrisi kontrolü (YCC) | Uyguladı (2016-2024) | Hayır | Hayır | Hayır |
| Hisse senedi ETF alımı | Evet (doğrudan piyasa destekçisi) | Hayır | Hayır | Hayır |
| Ana tehdit | Deflasyon → Şimdi enflasyon | Enflasyon | Enflasyon | Yüksek enflasyon |
| Carry trade etkisi | Çok büyük (küresel ölçek) | Orta | Orta | Sınırlı |
...
Merkez bankalarının genel çerçevesini anlamak için [Merkez Bankası Nedir? Faiz Kararı Nasıl Alınır?](/blog/merkez-bankasi-nedir-faiz-karari) yazısını okuyabilirsin.
...
| Gösterge | Ne İzlenir? | Anlamı |
|----------|-------------|--------|
| USD/JPY kuru | Yen güçleniyor mu? | Güçlenen Yen = carry trade çözülüyor = risk-off |
| VIX endeksi | Volatilite artıyor mu? | Yüksek VIX = küresel panik = BIST baskı altında |
| MSCI Gelişen Piyasalar ETF | EM hisseleri satılıyor mu? | BOJ etkisinin gelişen piyasalara yansıması |
| Japon 10 yıllık tahvil faizi | YCC bandını aşıyor mu? | BOJ müdahale edecek mi sinyali |

BOJ toplantı tarihlerini takip etmek için Investing.com TR veya Foreks Haber ekonomik takvimlerini kullanabilirsin.

Yen carry trade krizinin [verim eğrisi](/blog/verim-egrisi-nedir-resesyon-isareti) ile ilişkisini anlamak da BOJ kararlarını yorumlamayı kolaylaştırır.
