---
title: "ABD Faiz Artırırsa Altın Ne Olur? Gerçek Veri, Gerçek Yanıt"
description: "ABD faiz artırırsa altın ne olur? Faiz-altın ters korelasyonunun mekanizması, tarihsel veri ve 2026 yatırımcısı için pratik rehber."
pubDate: 2026-09-23
category: "Ekonomi"
tags: ["altın fiyatı", "abd faiz kararı", "faiz altın ilişkisi", "reel faiz", "fed faiz artışı", "altın yatırımı"]
readingTime: 8
featured: false
faq:
  - q: "ABD faiz artırırsa altın düşer mi?"
    a: "Genel kural: evet, altın düşüş baskısına girer. Yüksek reel faiz, faiz getirmeyen altını tahvile kıyasla daha az cazip kılar. Ancak enflasyon aynı anda yüksekse, reel faiz yükselmeyebilir ve altın direnç gösterebilir."
  - q: "Faiz artışında altın mı, dolar mı tutmak daha iyi?"
    a: "Kısa vadede dolar güçlenme eğiliminde olduğundan dolar avantajlıdır. Ama faiz döngüsünün sonuna yaklaşıldığında altın genellikle dolar karşısında toparlanmaya başlar. Zamanlama kritiktir ve kesin bir cevap yoktur."
  - q: "Nominal faiz mi reel faiz mi altını etkiler?"
    a: "Reel faiz (nominal faiz eksi enflasyon beklentisi) altın için asıl belirleyicidir. Nominal faiz yükselse bile enflasyon daha hızlı yükseliyorsa reel faiz negatif kalır ve altın yükselmeye devam edebilir."
  - q: "2022'de Fed faiz artırdı ama altın neden çok düşmedi?"
...
Burada çoğu yatırımcının gözden kaçırdığı önemli bir nüans var: Altın için belirleyici olan **nominal faiz değil, reel faiz**tir.
...
| Durum | Nominal Faiz | Enflasyon Bek. | Reel Faiz | Altın Üzerindeki Etki |
|---|---|---|---|---|
| Klasik sıkılaşma | Yükseliyor | Düşüyor | Pozitife dönüyor | Baskı — altın düşüş riski |
| Geç dönem enflasyon | Yükseliyor | Daha hızlı yükseliyor | Negatif kalıyor | Altın direnç gösterebilir |
| Gevşeme başlangıcı | Düşüyor | Sabit | Düşüyor | Altın için olumlu |
| Deflasyon korkusu | Düşüyor | Daha hızlı düşüyor | Yükseliyor | Altın baskı altında |
...
[Reel faiz nedir?](/blog/reel-faiz-nedir) yazımızda bu hesaplamayı adım adım bulabilirsiniz.
...
| Dönem | Fed'in Faiz Hareketi | Altının Performansı | Açıklama |
|---|---|---|---|
...
BOE Başkanı Bailey'nin konuşmaları piyasaların sterlin faiz yolunu fiyatlamasına yardımcı olur. Bu tür açıklamaları izlemek için [BOE Faiz Kararı Nedir?](/blog/boe-faiz-karari-nedir-etkisi) yazımıza başvurabilirsiniz.
...
- **Belirleyici olan reel faiz**tir; nominal faiz yükselse bile enflasyon daha hızlı artıyorsa altın direnç gösterebilir.
