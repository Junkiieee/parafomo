---
title: "ABD Faiz Artarsa Ne Olur? Dolar, TL, Altın ve Borsaya Etkisi"
description: "ABD faiz artarsa dolar, TL, altın ve borsa nasıl etkilenir? Fed faiz artışının adım adım piyasa mekanizması ve Türk yatırımcısı için pratik rehber."
pubDate: 2026-08-21
category: "Ekonomi"
tags: ["abd faiz kararı", "fed faiz artışı", "dolar tl", "altın fiyatı", "amerikan faizi"]
readingTime: 8
featured: false
faq:
  - q: "ABD faizi artarsa dolar güçlenir mi?"
    a: "Genellikle evet. Yüksek faiz, doları daha cazip hale getirdiği için yabancı sermaye ABD'ye akar, dolar endeksi (DXY) yükselir. Ancak piyasa beklentisi faiz artışını zaten fiyatlamışsa, karar sonrası dolar zayıflayabilir."
  - q: "ABD faizi artarsa TL ne olur?"
    a: "TL üzerinde genellikle değer kaybettirici baskı oluşur. Yatırımcılar daha yüksek getiri sunan ABD varlıklarına yönelince gelişmekte olan ülkelerden (Türkiye dahil) sermaye çıkışı yaşanır."
  - q: "ABD faizi artarsa altın düşer mi?"
    a: "Çoğunlukla evet. Yüksek faiz, faiz getirmeyen altını daha az cazip kılar. Ancak aşırı faiz artışı enflasyon savaşı olarak yorumlanırsa altın bir süreliğine yükselmeye devam edebilir."
  - q: "ABD faiz artışından önce ne yapmalıyım?"
...
[Dolar endeksi (DXY) nasıl okunur?](/blog/dolar-endeksi-dxy-nedir) yazımızda bu mekanizmayı detaylandırdık.
...
1. **Carry trade çözülmesi:** Yatırımcılar TL gibi yüksek faizli para birimlerinde taşıma işlemi (carry trade) yapar. ABD faizi yükselince TL'nin sağladığı faiz avantajı daralır; bu pozisyonlar kapanmaya başlar, TL satılır.
2. **Sermaye çıkışı:** Gelişmekte olan piyasalardan çıkan para "güvenli liman" olarak ABD'ye akar.
3. **Türkiye risk primine ek baskı:** Dolar yükselirken Türkiye'nin dış borç yükümlülükleri TL cinsinden ağırlaşır.
...
1. **İskonto oranı etkisi:** Şirket değerlemesi, gelecekteki kazançların bugüne indirgenmesiyle hesaplanır. Faiz yükselince bu iskonto oranı artar, dolayısıyla aynı kazanç için şirket değeri düşer.
2. **Borçlanma maliyeti:** Şirketlerin krediye erişimi pahalılaşır, kâr marjları daralır.
3. **Alternatif maliyet:** Yatırımcılar, riskli hisse senedi yerine artık daha cazip olan tahvillere kayar.
...
ABD faiz artışı BIST 100'e olumsuz yansır; yabancı sermaye çıkışı ve TL değer kaybı hisse değerlemelerini zorlar. Ancak ihracatçı sektörler (tekstil, savunma, gıda) kurdaki yükselişten görece avantaj sağlar. [ABD faiz kararının altın, dolar ve TL'ye etkisini](/blog/abd-faiz-karari-altin-dolar-tl-etkisi) anlatan rehberimizde bu dinamik daha geniş ele alınıyor.
...
1. **Kur riskini değerlendir:** Dolar pozisyonunuz yoksa ya da TL mevduatta takılıysanız kur hareketlerine karşı savunmasız olabilirsiniz.
2. **Vadeli TL enstrümanlarına dikkat:** Faiz artışı dönemlerinde kısa vadeli mevduat uzun vadeli kilitlemeye kıyasla avantajlı olabilir; zira faizler daha da yükselebilir.
3. **BIST portföyünde ihracatçıları izle:** Dolar geliri olan şirketler TL değer kaybında doğal bir koruma sağlar.
4. **Altın pozisyonunu gözden geçir:** Faiz artış döngüsünün ne kadar süreceğini ve piyasanın resesyon riskini nasıl fiyatladığını takip et.
5. **Tahvil/bono alternatifleri:** Yükselen faiz ortamında kısa vadeli tahvil ve Hazine bonosu cazip hale gelebilir.

[Reel faiz nedir?](/blog/reel-faiz-nedir) yazımızda enflasyona göre gerçek getirinizi hesaplama yöntemini bulabilirsiniz.
