---
title: "Emeklilikte Ne Kadar Paraya İhtiyacın Var? Gerçekçi Hesap Rehberi"
description: "Emeklilik için ne kadar para biriktirmen gerektiğini hesapla: Türkiye koşullarında yaşam gideri, enflasyon ve SGK maaşı dahil adım adım gerçekçi emeklilik hedefi rehberi."
pubDate: 2026-07-21
category: "Emeklilik"
tags: ["emeklilik", "emeklilik planlaması", "emeklilik için para", "BES", "tasarruf", "SGK", "finansal planlama"]
readingTime: 8
featured: false
faq:
  - q: "Emeklilik için ne kadar para yeterli?"
    a: "Emeklilikte harcamak istediğiniz yıllık tutarın 25 katı klasik hedeftir (yüzde 4 kuralı). Türkiye'de yüksek enflasyon nedeniyle bu katsayıyı 30–33 katına yükseltmek daha güvenlidir. SGK maaşı varsa fark kadar özel birikim yeterli olabilir."
  - q: "Emeklilikte aylık ne kadar harcama hesaplanmalı?"
    a: "Mevcut aylık giderinizi emeklilik yılına kadar yıllık enflasyonla artırın. Sağlık giderleri için yüzde 10–15 ekleyin; çocuk ve iş giderleri düşer ama seyahat ve sağlık artar. Gerçekçi bir bütçe için son 3 ayın extresini inceleyin."
  - q: "SGK emekli maaşı ne kadar emeklilik açığını kapatır?"
    a: "SGK maaşınız gerçekçi yaşam giderlerinizin altındaysa aradaki fark 'emeklilik açığı' olur. Bu açığı BES, bireysel yatırım portföyü veya kira geliri gibi kaynaklarla kapatmak gerekir. SGK maaşını ayrı olarak hesaplayıp toplam hedefinizden düşün."
  - q: "Kaç yaşında emeklilik planlamaya başlamak gerekir?"
...
| Gider Kalemi | Emeklilik Öncesi | Emeklilik Sonrası |
|---|---|---|
| Konut (kira/aidat) | Devam eder | Devam eder |
| Sağlık | Düşük | **Belirgin biçimde artar** |
| İş/ulaşım | Yüksek | Düşer |
| Çocuk/eğitim | Yüksek | Düşer (genellikle) |
| Seyahat/boş zaman | Sınırlı | Artar |
| Yemek | Devam eder | Benzer kalır |
| Bakım giderleri (yaşlılık) | Yok | İlerleyen yıllarda artar |
...
| Yaşam Standardı | Tahmini Aylık Gider (TL) | Yıllık Gider (TL) | 33x Hedef Birikim (TL) |
|---|---|---|---|
| Mütevazı (kira yok, küçük şehir) | 15.000 | 180.000 | 5.940.000 |
| Orta (kiralı, büyükşehir) | 30.000 | 360.000 | 11.880.000 |
| Konforlu (kiralı, seyahat, sağlık) | 55.000 | 660.000 | 21.780.000 |
...
Emekliliğe kalan yıl sayısını ve gerçekçi bir yıllık reel getiri oranını (%5–7 gerçekçi uzun vade) kullanarak aylık katkı tutarını bulabilirsin. Bileşik getirinin buradaki gücünü anlamak için [Bileşik Getiri Nedir ve Neden Bu Kadar Güçlü?](/blog/bilesik-faiz-nedir/) yazımıza göz atabilirsin.

## Emeklilik Planında Göz Ardı Edilen 4 Risk

**1. Uzun yaşam riski:** Ortalama yaşam süresi uzuyor. 30 yıl için hesaplanan plan 40 yıla yetmeyebilir. Emeklilik portföyünü büyütecek araçların başında devlet katkısıyla BES geliyor; [BES Mantıklı mı?](/blog/bes-bireysel-emeklilik-mantikli-mi/) yazımızda artı ve eksileri ayrıntılı ele aldık.
...
Emeklilik planınızı uzun vadeli büyüme için nasıl çeşitlendireceğinize dair daha geniş bir perspektif için [Finansal Özgürlük Nedir? FIRE Hareketi Rehberi](/blog/finansal-ozgurluk-nedir-fire/) yazımıza bakabilirsiniz.
