---
title: "Portföy Çeşitlendirmesi Nasıl Yapılır? Yatırım Riskini Azaltma Rehberi"
description: "Portföy çeşitlendirmesi nasıl yapılır? Hisse senedi, tahvil, altın ve fonları dengeleyerek riskinizi azaltın. Türkiye'ye özel pratik adımlar ve karşılaştırma tablosu."
pubDate: 2026-07-29
category: "Yatırım"
tags: ["portföy çeşitlendirmesi", "risk yönetimi", "varlık dağılımı", "portföy yönetimi", "yatırım stratejisi"]
readingTime: 8
featured: false
faq:
  - q: "Portföy çeşitlendirmesi nasıl yapılır?"
    a: "Tek bir varlığa değil, farklı sınıflara (hisse senedi, tahvil, altın, döviz) yatırım yaparak başlarsınız. Her sınıf farklı koşullarda farklı davrandığından toplam portföy oynaklığı düşer."
  - q: "Kaç farklı yatırım aracına yatırım yapılmalı?"
    a: "Akademik araştırmalar 10-20 farklı hisse ile sistematik riskin büyük bölümünün azaldığını gösteriyor; fakat sadece hisse değil varlık sınıflarını çeşitlendirmek daha etkili. 3-5 farklı varlık sınıfı iyi bir başlangıçtır."
  - q: "Hisse senedi ve tahvil oranı ne olmalı?"
    a: "Klasik '100 eksi yaş' kuralına göre 30 yaşındaki biri %70 hisse, %30 tahvil tutabilir. Ancak bu kural genel bir kılavuzdur; risk toleransınıza ve Türkiye koşullarına göre uyarlamanız gerekir."
  - q: "Yeni başlayanlar için en kolay çeşitlendirme yöntemi nedir?"
...
| Profil | Hisse | Tahvil/Bono | Altın | Döviz | Fon/ETF |
|--------|-------|-------------|-------|-------|---------|
...
[Endeks fonu nedir ve nasıl alınır](/blog/endeks-fonu-nedir) yazımızda bu araçları detaylıca anlattık.
...
[DCA nedir ve nasıl uygulanır](/blog/dca-nedir-maliyet-ortalamasi) yazımızda bu stratejiyi adım adım anlattık.

## Türkiye'de Çeşitlendirme Seçenekleri Karşılaştırması

| Araç | Getiri Potansiyeli | Risk | Likidite | Min. Tutar | Vergi |
|------|-------------------|------|----------|------------|-------|
| BIST hisseleri | Yüksek | Yüksek | Yüksek | ~100 TL | %0 (1 yıl üstü) |
| Devlet tahvili | Orta | Düşük | Orta | ~1.000 TL | %10 stopaj |
| Gram altın (fisik) | Orta | Orta | Orta | ~Piyasa fiyatı | Değer artışında yok |
| Altın fonu | Orta | Orta | Yüksek | ~1 TL | %10 stopaj |
| Döviz (USD/EUR) | TL bazlı orta | Orta | Yüksek | ~1 TL | %0 (gerçekleşene) |
| Endeks fonu / ETF | Orta-Yüksek | Orta | Yüksek | ~1 TL | %10 stopaj |
| Eurobond | Orta | Orta | Düşük | ~100.000 TL | %0 (itfa) |

[Yatırım fonu nedir, nasıl seçilir](/blog/yatirim-fonu-nedir-nasil-secilir) yazımızda fon seçiminde dikkat edilmesi gereken kriterleri bulabilirsin.
...
[Risk ve getiri ilişkisi](/blog/risk-getiri-iliskisi) yazımızda çeşitlendirmenin matematiksel temelini daha derin inceledik.
