---
title: "Ortalama Saatlik Kazançlar Nedir? Ücret Enflasyonu ve Fed Faiz Etkisi"
description: "Ortalama saatlik kazançlar nedir, nasıl okunur? ABD ücret enflasyonu verisi Fed faiz kararını ve dolayısıyla dolar/TL kurunu nasıl etkiler? Türk yatırımcı rehberi."
pubDate: 2026-08-07
category: "Ekonomi"
tags: ["ortalama saatlik kazançlar", "ücret enflasyonu", "fed faiz kararı", "abd istihdam verisi", "dolar tl", "average hourly earnings"]
readingTime: 7
featured: false
faq:
  - q: "Ortalama saatlik kazançlar ne zaman açıklanır?"
    a: "Her ayın ilk Cuma günü saat 15:30 Türkiye saatiyle NFP ve işsizlik oranıyla birlikte açıklanır. Bu üç veri tek bir raporun (BLS İstihdam Durumu Raporu) parçasıdır."
  - q: "Ortalama saatlik kazançlar yüksek gelirse ne olur?"
    a: "Beklentinin üzerinde ücret artışı, işgücü piyasasındaki enflasyon baskısını gösterir. Fed'in faiz indirmeyi erteleyeceği yorumuyla dolar değer kazanır, altın geri çekilir, TL üzerinde baskı oluşabilir."
  - q: "Ücret enflasyonu neden önemlidir?"
    a: "Ücretler yükselince işletmeler maliyetlerini fiyatlara yansıtır; bu süreç enflasyonu besler ve kalıcı hale getirir. Fed bu 'ikincil etki' riskine karşı faiz politikasını kalibre eder."
  - q: "Bu veri Türk yatırımcısını nasıl etkiler?"
...
Ücretler artınca:
1. İşçi harcamaları artar → talep enflasyonu yükselir.
2. Şirketler artan işgücü maliyetini fiyatlara yansıtır → maliyet enflasyonu baskısı oluşur.
3. Yüksek fiyatlar → çalışanlar daha fazla ücret talep eder → döngü devam eder.
...
[PCE (Kişisel Tüketim Harcamaları) endeksi](/blog/pce-nedir-fed-enflasyon-gostergesi) ve CPI geriye bakar: dün satılan malların fiyatını ölçer. Ortalama saatlik kazançlar ise **üretim tarafındaki baskıyı** gösterir; bu onu **öncü gösterge** yapar. Yani yüksek ücret artışı, önümüzdeki aylarda PCE/CPI baskısına dönüşebilir.
...
Veriyi tek başına değil, [NFP (Tarım Dışı İstihdam)](/blog/nfp-nedir-abd-tarim-disi-istihdam) ve [işsizlik oranıyla](/blog/abd-issizlik-orani-nedir-nfp-etkisi) birlikte okumak, tablo-yu çok daha net ortaya koyar.
...
Piyasalar bu yorumu yalnızca aylık veriyle değil, son 3-6 aylık ortalamaya bakarak yapar. Tek bir sürpriz veri değil, **eğilim** önemlidir. [Fed faiz kararı sürecini](/blog/fed-faiz-karari-nedir-etkisi) daha ayrıntılı anlamak için ilgili yazımıza bakabilirsin.
...
**1. Ücret enflasyonu yüksek → Fed faiz tutmaya devam eder**
→ ABD tahvil getirisi yüksek kalır → küresel sermaye ABD'ye çekilir
→ Türkiye gibi ülkelere fon girişi azalır → TL üzerinde değer kaybı baskısı
→ Dolar/TL kuru yükselir; döviz borcu olan şirketler daha fazla maliyet yazar

**2. Ücret enflasyonu düşük → Fed faiz indirimine yaklaşır**
→ Dolar zayıflar → gelişmekte olan piyasalara risk iştahı açılır
→ TL ve BIST için daha olumlu bir ortam oluşur
...
1. Açıklama öncesi piyasanın beklediği konsensüs rakamını öğren (Investing.com, Bloomberg).
2. Veri açıklandıktan sonra ilk 5 dakikada piyasayı doğrudan izleme; volatilite yüksek, algılama güçtür.
3. Veriyi NFP ve işsizlik oranıyla birlikte değerlendir; tek başına yorum yapmak yanıltıcı olabilir.
4. Piyasa 30 dakika sonra daha net bir yön seçer; bu noktada eğilim okunabilir.
...
- Tek veriyle değil, [NFP](/blog/nfp-nedir-abd-tarim-disi-istihdam), [işsizlik oranı](/blog/abd-issizlik-orani-nedir-nfp-etkisi) ve uzun vadeli ücret eğilimiyle birlikte yorumlamak daha sağlıklı karar verdirir.
