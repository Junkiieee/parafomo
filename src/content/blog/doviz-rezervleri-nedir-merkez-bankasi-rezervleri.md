---
title: "Döviz Rezervleri Nedir? Merkez Bankası Rezervlerini Anlamak İçin Rehber"
description: "Döviz rezervleri nedir, brüt ile net rezerv farkı ne demek? Türkiye'nin TCMB rezervleri TL kuru ve ekonomiyi nasıl etkiler? Yatırımcı rehberi."
pubDate: 2026-08-26
category: "Ekonomi"
tags: ["döviz rezervleri", "merkez bankası", "tcmb", "net rezerv", "brüt rezerv", "türkiye ekonomisi"]
readingTime: 7
featured: false
faq:
  - q: "Döviz rezervleri nedir, ne işe yarar?"
    a: "Döviz rezervleri, bir ülkenin merkez bankasının elinde tuttuğu yabancı para, altın ve uluslararası varlıkların toplamıdır. Döviz kurunu savunmak, dış borçları ödemek ve uluslararası ticareti finanse etmek için kullanılır."
  - q: "Brüt rezerv ile net rezerv arasındaki fark nedir?"
    a: "Brüt rezerv, merkez bankasının toplam döviz varlıklarıdır. Net rezerv ise brüt rezervden yükümlülükler (özellikle yabancı banklarla yapılan swap borçları) düşüldükten sonra kalan gerçek kullanılabilir miktardır. Net rezerv, ülkenin gerçek döviz gücünü gösterir."
  - q: "Türkiye'nin TCMB döviz rezervleri ne kadar?"
    a: "TCMB'nin brüt rezervleri yaklaşık 150–170 milyar dolar civarında seyreder, ancak swap borçları ve diğer yükümlülükler düşüldüğünde net rezervler önemli ölçüde daha düşük kalır. Güncel rakamlar için TCMB'nin haftalık Analitik Bilanço verilerini takip edin."
  - q: "Swap anlaşması rezervleri nasıl etkiler?"
...
Döviz rezervleri; bir ülkenin [merkez bankası](/blog/merkez-bankasi-nedir-faiz-karari) tarafından yönetilen ve uluslararası piyasalarda kabul gören varlıkların toplamıdır. Yabancı para (dolar, euro, sterlin vb.), altın, IMF Özel Çekme Hakları (SDR) ve IMF'deki rezerv pozisyonundan oluşur.
...
|---------|----------|-----------|
| Döviz varlıkları | USD, EUR, GBP vb. yabancı para | %60–75 |
| Altın | Merkez bankası altın stoğu | %10–20 |
| SDR (Özel Çekme Hakkı) | IMF'nin sentetik rezerv para birimi | %5–10 |
| IMF Rezerv Pozisyonu | IMF'ye yapılan katkıdan doğan talep hakkı | %1–5 |
...
|--------|-----------------|---------------|
| **Brüt Rezerv** | Merkez bankasının elindeki tüm döviz varlıkları | Toplam büyüklük, ancak yükümlülükleri dışarıda bırakır |
| **Net Rezerv** | Brüt rezerv − kısa vadeli döviz yükümlülükleri | Gerçek kullanılabilir döviz gücü |
| **Swap Etkisi** | Yabancı bankalardan geçici alınan döviz brüte eklenir, ama geri ödenecektir | Net rezervde görünmez, hatta negatif etkiler |
...
[Döviz kuru](/blog/doviz-kuru-nasil-belirlenir) aşırı dalgalandığında merkez bankası piyasaya döviz satarak kuru stabilize etmeye çalışabilir. Yeterli rezerv olmadan bu müdahale mümkün olmaz.
...
[Cari açık](/blog/cari-acik-nedir-turkiye-tl-etkisi) yüksek seyreden dönemlerde rezervler hızla erir; çünkü cari açığın bir kısmının dövizle finanse edilmesi gerekir. Bu döngü, Türkiye'nin "yüksek cari açık → rezerv erimesi → TL baskısı" kısır döngüsünü oluşturur.

### Dikkat Edilmesi Gereken Oranlar

| Gösterge | Ne anlama gelir? | Sağlıklı eşik |
|----------|-----------------|---------------|
| Rezervler / İthalat | Kaç aylık ithalat karşılanır? | ≥ 3 ay |
| Rezervler / Kısa Vadeli Dış Borç | Borç ödeme yeterliliği | ≥ 1.0 |
| Net Rezervler (swap hariç) | Gerçek kullanılabilir döviz | Pozitif olmalı |
| Brüt Rezerv Değişimi (aylık) | Rezerv akımı yönü | Kalıcı düşüş tehlike sinyali |
...
| Ülke | Brüt Rezerv (tahmini) | Rezerv / İthalat |
|------|-----------------------|-----------------|
...
[TCMB faiz kararları](/blog/tcmb-faiz-karari-nasil-etkiler) da rezervlerle dolaylı bağlantılıdır: Yüksek reel faiz, yabancı sermaye çeker, rezervlere destek olur. Düşük faiz ortamında ise dövize talep artarak rezervleri zorlayabilir.
