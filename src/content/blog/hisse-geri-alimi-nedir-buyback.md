---
title: "Hisse Geri Alımı (Buyback) Nedir? Şirket Neden Kendi Hissesini Satın Alır?"
description: "Hisse geri alımı nedir, şirket neden kendi hissesini satın alır? EPS, hisse fiyatı ve temettüye etkisini, BIST örneklerini ve yatırım sinyalini öğren."
pubDate: 2026-08-25
category: "Borsa"
tags: ["hisse geri alımı", "buyback", "hisse senedi", "borsa", "temettü", "eps", "bist", "yatırım stratejisi"]
readingTime: 8
featured: false
faq:
  - q: "Hisse geri alımı (buyback) nedir kısaca?"
    a: "Hisse geri alımı, bir şirketin borsada dolaşan kendi hisselerini piyasadan satın almasıdır. Bu işlem sonucunda piyasadaki hisse sayısı azalır; kalan hisselerin pay başına kârı (EPS) ve değeri artabilir."
  - q: "Şirket neden kendi hissesini geri satın alır?"
    a: "Şirketler genellikle ellerinde fazla nakit olduğunda, hisselerini değerinin altında gördüklerinde veya mevcut hissedarların payını seyreltilebilecek seçenek ödülleri dengelemek için buyback yapar. Yönetimin hisseye güven sinyali olarak da okunabilir."
  - q: "Hisse geri alımı hisse fiyatını nasıl etkiler?"
    a: "Piyasadaki hisse arzı azaldığı için kalan hisselerin pay başına kârı (EPS) yükselir. Bu matematiksel artış F/K oranını görece düşürür ve hisseyi daha ucuz gösterir; kısa vadede fiyat baskısı genellikle yukarı yönlüdür."
  - q: "Buyback mı temettü mü yatırımcıya daha iyi?"
...
| Kriter | Hisse Geri Alımı | Temettü |
|---|---|---|
| **Nakit gelir** | Hisse satmadan yok | Düzenli nakit akışı |
| **Vergi (Türkiye)** | Hisseyi satınca gelir vergisi | Dağıtımda %15 stopaj |
| **Esneklik** | Şirket programı durdurabilir | Kesilebilir ama sinyali kötü |
| **EPS etkisi** | Olumlu (hisse azalır) | Yok (kâr dağıtılır, kalmaz) |
| **Hisse fiyat etkisi** | Genellikle olumlu | Kısa vadede temettü kadar düşer |
| **Yatırımcı profili** | Büyüme/değer yatırımcısı | Gelir yatırımcısı |
| **Şirket sinyali** | "Hisse ucuz" mesajı | "Nakit güçlü" mesajı |

**Pratik not:** Temettü tüketimine odaklananlar için [temettü hisseleri ve pasif gelir rehberi](/blog/temettu-hisseleri-pasif-gelir/) ayrı bir başlangıç noktasıdır. Buyback ise hissedarlık yüzdeni artırdığı için portföyünü büyütmek isteyenlere uygundur.
...
3. **Makul değerleme:** [F/K oranı](/blog/fk-orani-nedir/) ve diğer metrikler hissenin gerçekten ucuz olduğuna işaret etmeli.
...
6. **[Temel analizle hisseyi değerle:](/blog/hisse-senedi-nasil-secilir/)** Buyback güzel haberdir ama temel analiz olmadan karar vermek yanıltıcı olabilir.
