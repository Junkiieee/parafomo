---
title: "Verim Eğrisi (Yield Curve) Nedir? Resesyon Uyarısını Nasıl Okursun?"
description: "Verim eğrisi nedir, ters çevrilmiş eğri ne anlama gelir? 10Y-2Y spread ile resesyon sinyallerini ve yatırım kararlarını nasıl okuyacağını öğren."
pubDate: 2026-08-06
category: "Ekonomi"
tags: ["verim eğrisi", "yield curve", "resesyon", "tahvil getirisi", "Fed faiz", "ABD ekonomisi"]
readingTime: 8
featured: false
faq:
  - q: "Verim eğrisi nedir?"
    a: "Aynı ihraçcının — tipik olarak ABD Hazinesi'nin — farklı vadelerdeki tahvillerinin getirilerini tek bir grafikte birleştiren eğridir. Ekonominin öngörü aracı olarak resesyon dönemlerinde şekil değiştirir."
  - q: "Ters verim eğrisi ne zaman resesyon habercisi olur?"
    a: "2 yıllık ABD tahvil getirisi 10 yıllıktan yüksek çıktığında bu 'inversiyon' tarihsel olarak resesyondan 6-18 ay önce görülmüştür. 1970'ten bu yana her büyük ABD resesyonundan önce ters eğri gözlemlenmiştir."
  - q: "10Y-2Y spread nedir ve neden önemlidir?"
    a: "10 yıllık ile 2 yıllık ABD Hazine tahvili arasındaki getiri farkıdır. Bu spread negatife döndüğünde eğri 'ters' demektir ve piyasalar gelecekteki faiz indirimlerini — yani ekonomik yavaşlamayı — fiyatlamaktadır."
  - q: "Verim eğrisi hisse senetlerini nasıl etkiler?"
...
Fed'in faiz kararlarının ne olduğunu ve piyasalara etkisini daha iyi anlamak için [Fed faiz kararı yazımızı](/blog/fed-faiz-karari-nedir-etkisi) inceleyebilirsin.
...
Bankacılık modelini şöyle düşün: banka senden kısa vadeli mevduata düşük faiz öder, sana uzun vadeli kredi için yüksek faiz uygular. Bu iki oran arasındaki fark bankanın **net faiz marjı**dır.
...
1. **Risk iştahı azalırsa**: Fonlar EM'den (emerging markets) çıkar, TL baskı altına girebilir.
2. **Dolar zayıflarsa**: TL varlıkları ve döviz bazlı yatırımlar kısmen rahatlar.

Faizin ekonomi, döviz ve borsa üzerindeki genel etkisini öğrenmek için [faiz nedir yazımıza](/blog/faiz-nedir-ekonomiyi-nasil-etkiler) bakabilirsin.
...
- **FRED (Federal Reserve Bank of St. Louis)**: `fred.stlouisfed.org` → "10-Year minus 2-Year" araması → anlık spread grafiği
- **Investing.com** → ABD Hazine Tahvilleri bölümü → farklı vadeler karşılaştırılabilir

### Pratik kullanım adımları
1. Her ay başı 10Y-2Y spread'i not et.
2. Spread 0'ın altına düşerse portföy dengesini gözden geçir.
3. Tek veri noktasına göre karar alma; ISM PMI, işsizlik ve Fed toplantı beklentileriyle birlikte değerlendir.
