---
title: "Döviz Hesabı Nedir? Dövizde Nasıl Yatırım Yapılır?"
description: "Döviz hesabı nedir, nasıl açılır, vadesiz ve vadeli farkı nedir? Dolar, euro ve döviz yatırımında bilmeniz gerekenler tek rehberde."
pubDate: 2026-08-02
category: "Yatırım"
tags: ["döviz hesabı", "dolar yatırımı", "euro", "döviz yatırımı", "kur riski", "döviz çeşitleri"]
readingTime: 7
featured: false
faq:
  - q: "Döviz hesabı açmak için ne kadar para gerekir?"
    a: "Çoğu bankada minimum tutar yoktur; 1 dolar ya da 1 euro ile dahi açılabilir. Ancak bazı bankalar için farklı alt limit uygulanabilir, bankanızın güncel koşullarını kontrol edin."
  - q: "Döviz hesabındaki para TMSF güvencesi kapsamında mı?"
    a: "Evet. Türkiye'de bankacılık lisansına sahip bankalardaki döviz mevduatları da TMSF güvencesi altındadır; limit her yıl güncellenir, güncel tutarı TMSF'nin resmi sitesinden kontrol edin."
  - q: "Vadesiz ve vadeli döviz hesabı arasındaki fark nedir?"
    a: "Vadesiz hesapta paranıza istediğiniz zaman ulaşırsınız ama faiz getirisi ya düşük ya da sıfırdır. Vadeli hesapta paranızı belirli bir süre kilitlediniz, karşılığında daha yüksek döviz faizi kazanırsınız."
  - q: "Döviz hesabında vergi var mı?"
...
1. **Banka seçin:** Kullandığınız bankanın mobil uygulamasını açın ya da şubeye gidin.
2. **Hesap türünü belirleyin:** Vadesiz mi, vadeli mi? Vadeli seçiyorsanız vade süresini ve döviz cinsi (dolar/euro/sterlin vb.) seçin.
3. **Kimlik doğrulaması:** Mobil uygulamalarda yüz tanıma veya SMS kodu ile; şubede nüfus cüzdanıyla işlem yapılır.
4. **Para transferi yapın:** TL hesabınızdaki tutarı, o anki kur üzerinden dövize çevirerek hesabınıza aktarın.
5. **Faiz ve vade bilgilerini not alın:** Vadeli işlemlerde faiz oranı, vade tarihi ve erken çözüm koşulları önemlidir.
6. **Takip edin:** Kur hareketlerini ve vade tarihini düzenli kontrol edin.
...
- **Portföy çeşitlendirmesi:** Tüm birikimini TL'de tutmak tek para birimine bağımlılık yaratır. Döviz eklemek riski dağıtır. ([Portföy çeşitlendirmesi hakkında daha fazla bilgi için](/blog/portfoy-cesitlendirmesi-nasil-yapilir/))
...
- Faiz geliri elde etmek için vadeli döviz veya eurobond değerlendiriyorsanız. ([Eurobond yatırımı hakkında](/blog/eurobond-nedir/))
...
Dövizi portföyün tek aracı yapmak yerine, [Türkiye'de en iyi yatırım araçları 2026](/blog/turkiyede-en-iyi-yatirim-araclari-2026/) rehberindeki gibi **çeşitlendirilmiş bir yapının parçası** olarak kullanmak daha sağlıklıdır. Ayrıca döviz kurunu etkileyen ekonomik faktörleri anlamak için [döviz kuru nasıl belirlenir?](/blog/doviz-kuru-nasil-belirlenir/) yazısına göz atabilirsiniz.
